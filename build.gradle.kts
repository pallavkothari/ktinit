...
object Properties {
    ...
    const val jupiter_version = "5.8.1"
...
plugins {
    ...
    id("org.jetbrains.kotlin.jvm") version "1.5.31"     // I would like to reference a const here but that doesn't work from the command line even tho Intellij is OK with it
