...
object Properties {
    ...
    const val guava_version = "30.0-jre"
...
plugins {
    ...
    id("org.jetbrains.kotlin.jvm") version "1.4.10"     // I would like to reference a const here but that doesn't work from the command line even tho Intellij is OK with it
